...
description: Deep security review of code for vulnerabilities, threat vectors, and security design flaws. Use when asked to security-review code, a branch, a commit, a directory, or recent changes.
tools:
  - Bash
  - Read
  - Grep
